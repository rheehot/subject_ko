...
## 번역할 과제 찜하기
작업중/검토중/완료가 체크되지 않은 과제 중에서 본인이 하고 싶은 과제를 골라주세요 (master 브렌치 read.md 를 직접 수정하시면 됩니다)
...
* 다른 사람의 번역 위에 커밋을 쌓기
  1. git clone 으로 repo 를 받습니다.
  2. 해당 브랜치로 이동하여 수정합니다.
  3. push 합니다.
  4. 원 번역자가 리뷰를 하고 승인을 하게되면 새로운 커밋이 쌓이게 됩니다.
